...
function loadDate() {
  ...
  const yearGoal  = localStorage.getItem(goalKey('year')) || '';
  const monthGoal = localStorage.getItem(goalKey('month')) || '';
  const dayGoal   = localStorage.getItem(goalKey('day')) || '';

  document.getElementById('goalYear').value  = yearGoal;
  document.getElementById('goalMonth').value = monthGoal;
  document.getElementById('goalDay').value   = dayGoal;
...
function saveGoals() {
  localStorage.setItem(goalKey('year'), document.getElementById('goalYear').value);
  localStorage.setItem(goalKey('month'), document.getElementById('goalMonth').value);
  localStorage.setItem(goalKey('day'), document.getElementById('goalDay').value);
}
